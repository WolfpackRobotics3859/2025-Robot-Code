...
public class TunerConstants 
{
    ...
    public static final LegacySwerveDrivetrainConstants DRIVETRAIN_CONSTANTS = new LegacySwerveDrivetrainConstants()
            .withPigeon2Id(PIDGEON_ID)
            .withCANbusName(CANBUS_NAME);

    private static final LegacySwerveModuleConstantsFactory CONSTANT_CREATOR = new LegacySwerveModuleConstantsFactory()
    ...
    public static final LegacySwerveModuleConstants FRONT_LEFT = CONSTANT_CREATOR.createModuleConstants(
    ...
    public static final LegacySwerveModuleConstants FRONT_RIGHT = CONSTANT_CREATOR.createModuleConstants(
    ...
    public static final LegacySwerveModuleConstants BACK_LEFT = CONSTANT_CREATOR.createModuleConstants(
    ...
    public static final LegacySwerveModuleConstants BACK_RIGHT = CONSTANT_CREATOR.createModuleConstants(
