...
public class Elevator extends SubsystemBase {
  ...
  {
    VoltageOut voltageRequest = new VoltageOut(null);
  ...
  {
    DutyCycleOut dutyCycleRequest = new DutyCycleOut((Double) null);
  ...
  {
    MotionMagicVoltage positionRequest = new MotionMagicVoltage(null);
