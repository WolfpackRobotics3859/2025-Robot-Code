...
public class ElevatorPosition1 extends Command 
{
   private final Elevator m_Elevator;
  /** Creates a new ElevatorPosition1. */
  public ElevatorPosition1(Elevator p_Elevator) 
  {
   ...
   * @param ElevatorConstants.ELEVATOR_POSITION_0 coral L2 position
   */
  // Called when the command is initially scheduled.
  @Override
  public void initialize() 
  {
    m_Elevator.elevatorRequest(Global.MODE.POSITION, ElevatorConstants.ELEVATOR_POSITION_1);
  }
