...
public class TunerConstants 
{
    ...
    private static final Slot0Configs steerGainsLeftFront = new Slot0Configs()
        ...
        .withKS(0.26576).withKV(1.4004).withKA(0.056515)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    ...
    private static final Slot0Configs steerGainsRightFront = new Slot0Configs()
        ...
        .withKS(0.23307).withKV(1.4441).withKA(0.81172)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    ...
    private static final Slot0Configs steerGainsLeftRear = new Slot0Configs()
        ...
        .withKS(0.21906).withKV(1.4337).withKA(0.042902)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    ...
    private static final Slot0Configs steerGainsRightRear = new Slot0Configs()
        ...
        .withKS(0.26899).withKV(1.4086).withKA(0.049733)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    ...
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGainsFrontLeft = new Slot0Configs()
        .withKP(0.17188).withKI(0).withKD(0)
        .withKS(0.034808).withKV(0.11803);

    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGainsFrontRight = new Slot0Configs()
        .withKP(0.17857).withKI(0).withKD(0)
        .withKS(0.022021).withKV(0.11694);

    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGainsRearLeft = new Slot0Configs()
        .withKP(0.17831).withKI(0).withKD(0)
        .withKS(0.045779).withKV(0.11705);

    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGainsRearRight = new Slot0Configs()
        .withKP(0.17091).withKI(0).withKD(0)
        .withKS(-0.045987).withKV(0.1138);
    ...
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontLeft =
        ...
        ).withSteerMotorGains(steerGainsLeftFront).withDriveMotorGains(driveGainsFrontLeft);
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontRight =
        ConstantCreator.createModuleConstants(
            kFrontRightSteerMotorId, kFrontRightDriveMotorId, kFrontRightEncoderId, kFrontRightEncoderOffset,
            kFrontRightXPos, kFrontRightYPos, kInvertRightSide, kFrontRightSteerMotorInverted, kFrontRightEncoderInverted
        ).withSteerMotorGains(steerGainsRightFront).withDriveMotorGains(driveGainsFrontRight);
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackLeft =
        ConstantCreator.createModuleConstants(
            kBackLeftSteerMotorId, kBackLeftDriveMotorId, kBackLeftEncoderId, kBackLeftEncoderOffset,
            kBackLeftXPos, kBackLeftYPos, kInvertLeftSide, kBackLeftSteerMotorInverted, kBackLeftEncoderInverted
        ).withSteerMotorGains(steerGainsLeftRear).withDriveMotorGains(driveGainsRearLeft);
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackRight =
        ConstantCreator.createModuleConstants(
            kBackRightSteerMotorId, kBackRightDriveMotorId, kBackRightEncoderId, kBackRightEncoderOffset,
            kBackRightXPos, kBackRightYPos, kInvertRightSide, kBackRightSteerMotorInverted, kBackRightEncoderInverted
        ).withSteerMotorGains(steerGainsRightRear).withDriveMotorGains(driveGainsRearRight);
