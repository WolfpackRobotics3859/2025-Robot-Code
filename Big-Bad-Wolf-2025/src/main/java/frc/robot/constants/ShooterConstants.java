...
public class ShooterConstants 
{
    ...
    public static final Slot0Configs WRIST_MOTOR_SLOT_0_CONFIG = new Slot0Configs()
                                                                    ...
                                                                    .withKA(0.01)  // Helps smooth acceleration
                                                                    .withKD(0.01)  // Helps reduce overshoot
                                                                    .withKG(0.3)   // Helps hold the wrist in place, adjust based on testing
                                                                    .withKI(0.0)   // Start with 0; only increase if there's steady-state error
                                                                    .withKP(0.5)   // Start low and increase for accurate positioning
                                                                    .withKS(0.1)   // Helps overcome static friction
                                                                    .withKV(0.1)   // Helps with smooth movement
