...
public class ShooterConstants 
{
    ...
    public static final double WRIST_CORAL_DEPLOY_POSITION = 0;
    public static final double WRIST_CORAL_INTAKE_POSITION = 0;
    
    public static final double CORAL_INTAKING_ROLLER_VOLTAGE = 4;
    public static final double SHOOTER_SHOOTING_ROLLER_VOLTAGE = -6;
    public static final double SHOOTER_STOW_ROLLER_VOLTAGE = 0;
    ...
    public static final double CORAL_PLACER_LEVEL_TWO_POSITION = 0;
    public static final double CORAL_PLACER_LEVEL_THREE_POSITION = 0;
    public static final double CORAL_PLACER_LEVEL_FOUR_POSITION = 0;
