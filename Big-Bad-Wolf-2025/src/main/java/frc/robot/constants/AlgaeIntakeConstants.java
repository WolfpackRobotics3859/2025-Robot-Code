...
public class AlgaeIntakeConstants
{
    ...
    public static final double ALGAE_INTAKE_WRIST_GROUND_POSITION = 7.8;
    public static final double ALGAE_INTAKE_WRIST_PROCESSING_POSITION = 0;

    public static final double ALGAE_INTAKE_ROLLER_VOLTAGE = 4;
    public static final double ALGAE_INTAKE_ROLLER_PROCESSING_VOLTAGE = -4;
